...
$$
\cfrac{\partial^4 \phi}{\partial x^4} + 2\,\cfrac{\partial^4 \phi}{\partial x^2\,\partial y^2} + \cfrac{\partial ^4 \phi}{\partial y^4} = 0
$$

$$
\int_0^\infty \, \tan ^{-1} (x) + \cfrac{\mu\,\theta\,e^{2t}}{16\,\pi\,\psi} \leq 19
$$

$$
\bmat{0.1cm}{2 * 5 * 7 * 9 * 6 @
               0.005 * 1\cdot 10^{-4} * 3 * \frac{2}{\sin \,x} * \mu @
               4 * 9 * 3 * 7 * 6}
$$
